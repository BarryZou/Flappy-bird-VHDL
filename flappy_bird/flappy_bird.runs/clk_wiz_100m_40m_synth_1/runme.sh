...
HD_PWD='D:/OneDrive/VivadoProj/EE332/flappy_bird/flappy_bird.runs/clk_wiz_100m_40m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_100m_40m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_100m_40m.tcl
